...
import {
  ...
  getCurrentMdCodeId, getCurrentMdSubCodeId, getCurrentMdMarkerId,
  getPopUpActive,
  getRightPanelTab,
...
export default connect(
  state => ({
    ...
    currentMdCodeId    : getCurrentMdCodeId(state),
    currentMdSubCodeId : getCurrentMdSubCodeId(state),
    currentMdMarkerId  : getCurrentMdMarkerId(state),
