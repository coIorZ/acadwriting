...
export const getCurrentMdCodeId = state => state.currentMdCodeId;
export const getCurrentMdSubCodeId = state => state.currentMdSubCodeId;
export const getCurrentMdMarkerId = state => state.currentMdMarkerId;
